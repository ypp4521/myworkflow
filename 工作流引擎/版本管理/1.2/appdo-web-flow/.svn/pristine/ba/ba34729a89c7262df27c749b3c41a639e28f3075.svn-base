...
<!-- 
 ...
 -->	
	...
	<script src="editor-app/configuration/properties-assignmentselect-controller.js" type="text/javascript"></script>
	<script src="editor-app/configuration/properties-candidateUserselect-controller.js" type="text/javascript"></script>
	<script src="editor-app/configuration/properties-candidateGroupselect-controller.js" type="text/javascript"></script>
