...
public class MyStringUtils {
	 ...
	 * @Exception 异常对象    <br/>
	 */
	public static String sql_create_in(String [] ids){
	...
	public static String sql_create_or(String colm,String [] ints){
		StringBuffer sql  =new StringBuffer(" (");
		for(int i=0;i<ints.length;i++){
            sql.append(colm).append(" = ").append(ints[i]);
            if(ints.length-1!=i){
                sql.append(" or ");
            }
        }
